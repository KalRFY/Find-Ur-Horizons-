...
<body>
    ...
    <header class="d-flex col-12 text-white align-items-center">
        ...
        <div class="quest-body">
            <p class="text-center">Malam haripun tiba, anda kesulitan untuk mencari tempat bermalam. Anda melihat sekitar dengan seksama menggunakan obor. Anda melihat ada beberapa tempat untuk bermalam. Mana yang akan anda pilih?</p>
        </div>
        <form action="../script/quest13.php" method="POST" class="d-flex flex-column align-items-end p-5">
            <div class="form-body d-flex gap-3 mb-5">
                <input type="radio" class="btn-check" name="choice" id="choice_a" autocomplete="off" value="a">
                <label class="btn" for="choice_a">Untuk mengantisipasi serangan hewan buas anda memilih untuk bermalam di atas Pohon Tua yang cukup besar dan kurang nyaman untuk beristirahat</label>
                
                <input type="radio" class="btn-check" name="choice" id="choice_c" autocomplete="off" value="b">
                <label class="btn" for="choice_c">Untuk memulihkan tenaga anda memilih untuk bermalam di dalam Gua kecil yang cukup hangat</label>
            </div>
