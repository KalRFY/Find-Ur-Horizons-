...
<body>
    <section class="upper-section d-flex align-items-center flex-column">
        ...
        <div class="quest-body">
            <p class="text-center">Pada suatu hari, terdengar desas-desus di desa bahwa di sebuah hutan berbahaya di atas gunung terdapat kristal ajaib yang dapat menunjukkan jati diri dan potensi seseorang. Kristal tersebut hanya akan bersinar pada musim gugur. Anda, seorang petualang muda yang sedang mencari jati dirinya, memutuskan untuk melakukan perjalanan untuk mendapatkan kristal ajaib itu.</p>
        </div>
        <form action="../script/quest_start.php" method="POST" class="d-flex flex-column align-items-end p-5">
