    ...
    <header class="d-flex col-12 text-white align-items-center">
        ...
        <form action="../script/quest17.php" method="POST" class="d-flex flex-column align-items-end p-5">
            <div class="form-body d-flex gap-3 mb-5">
                ...
                <label class="btn" for="choice_b">Tidak meminum Air Sungai tersebut  dan hanya membasuh wajah saja</label>
