...
<body>
    ...
    <header class="d-flex col-12 text-white align-items-center">
        ...
        <div class="quest-body">
            <p class="text-center">Setelah tenda siap Anda beristirahat dengan kelompok tersebut, pada pagi harinya Anda dan kelompok tersebut melanjutkan perjalanan. Di tengah perjalanan, Anda mendengar suara gemerisik di semak-semak. Apa yang akan Anda lakukan?</p>
        </div>
        <form action="../script/quest6.php" method="POST" class="d-flex flex-column align-items-end p-5">
            <div class="form-body d-flex gap-3 mb-5">
                <input type="radio" class="btn-check" name="choice" id="choice_a" autocomplete="off" value="a">
                <label class="btn" for="choice_a">Mengeluarkan pisau untuk melindungi diri</label>
                
                <input type="radio" class="btn-check" name="choice" id="choice_b" autocomplete="off" value="b">
                <label class="btn" for="choice_b">Mencoba untuk mengidentifikasi suara tersebut dengan tenang</label>
                
                <input type="radio" class="btn-check" name="choice" id="choice_c" autocomplete="off" value="c">
                <label class="btn" for="choice_c">Segera bersiap berlari menuju arah yang berlawanan</label>
            </div>
