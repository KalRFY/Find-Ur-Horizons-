...
<body>
    ...
    <header class="d-flex col-12 text-white align-items-center">
        ...
        <div class="quest-body">
            <p>2. Saat dalam perjalanan, Anda bertemu dengan seorang penduduk desa yang berlari sambil berteriak. Apa yang akan Anda lakukan?</p>
        </div>
        <form action="../script/quest2.php" method="POST" class="d-flex flex-column align-items-end p-5">
            <div class="form-body d-flex gap-3 mb-5">
                <input type="radio" class="btn-check" name="choice" id="choice_a" autocomplete="off" value="a">
                <label class="btn" for="choice_a">Melakukan persiapan dengan matang, seperti menyiapkan perbekalan, peta, dan peralatan yang diperlukan.</label>
                
                <input type="radio" class="btn-check" name="choice" id="choice_b" autocomplete="off" value="b">
                <label class="btn" for="choice_b">Langsung berangkat tanpa banyak persiapan, mengandalkan instingmu dan kemampuan beradaptasi dengan alam.</label>
            
                <input type="radio" class="btn-check" name="choice" id="choice_c" autocomplete="off" value="c">
                <label class="btn" for="choice_c">Melakukan persiapan seadanya dan mencari informasi lebih lanjut tentang lokasi kristal dan bahaya yang mungkin dihadapi di sepanjang perjalanan.</label>
            </div>
