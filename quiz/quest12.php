...
<body>
    ...
    <header class="d-flex col-12 text-white align-items-center">
        ...
        <div class="quest-body">
            <p class="text-center">Anda melanjutkan perjalanan menuju gunung dengan informasi yang seadanya. Di dalam perjalanan, Anda mendengar suara gemerisik di semak-semak. Apa yang akan Anda lakukan?</p>
        </div>
        <form action="../script/quest12.php" method="POST" class="d-flex flex-column align-items-end p-5">
