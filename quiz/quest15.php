...
<body>
    ...
    <header class="d-flex col-12 text-white align-items-center">
        ...
        <div class="quest-body">
            <p class="text-center">Setelah melewati rintangan tersebut, Andapun berhasil memasuki ruangan dan melihat Kristal Ajaib yang telah Anda cari selama ini. Akhirnya, Andapun menyentuh Kristal Ajaib tersebut, “Wahai Kristal Ajaib, Siapakah diriku sebenarnya?”. Lalu, Kristal Ajaib itupun mengeluarkan cahaya. Dan ternyata Anda adalah...</p>
        </div>
        <form action="../script/quest15.php" method="POST" class="d-flex flex-column align-items-end p-5">
