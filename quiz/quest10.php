...
<body>
    ...
    <header class="d-flex col-12 text-white align-items-center">
        ...
        <div class="quest-body">
            <p class="text-center">Anda mengikuti kelompok tersebut masuk ke hutan hingga malam tiba. Di balik pohon Anda melihat mereka memasang peralatan untuk bermalam. Namun, Anda tidak sengaja menginjak ranting pohon yang menimbulkan suara yang cukup keras sehingga Kelompok Misterius itupun sontak kaget. Apa yang akan anda lakukan?</p>
        </div>
        <form action="../script/quest10.php" method="POST" class="d-flex flex-column align-items-end p-5">
            <div class="form-body d-flex gap-3 mb-5">
                <input type="radio" class="btn-check" name="choice" id="choice_a" autocomplete="off" value="a">
                <label class="btn" for="choice_a">Langsung berlari kabur dan menjauh dari tempat itu agar tidak membahayakan diri</label>
                
                <input type="radio" class="btn-check" name="choice" id="choice_b" autocomplete="off" value="b">
                <label class="btn" for="choice_b">Keluar, dan menghampiri kelompok itu dan menanyakan tujuan mereka di hutan ini</label>
                
                <input type="radio" class="btn-check" name="choice" id="choice_c" autocomplete="off" value="c">
                <label class="btn" for="choice_c">Mengeluarkan alat yang ada untuk melindungi diri dan Keluar menghampiri Kelompok Misterius</label>
            </div>
